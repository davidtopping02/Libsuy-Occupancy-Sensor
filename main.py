...
class OccupancySensor:
    ...
    async def run_sensor_lifecycle(self):
        ...
        # self.health_checker.check_monitoring_mode_network_interfaces(self.monitoring_interface)

        while True:
            scan_result = await self.get_current_occupancy()
            OccupancyDataApiClient.submit_occupancy_data(self.sensor_id, scan_result)
